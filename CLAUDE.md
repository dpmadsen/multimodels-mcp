...
## Pra quem é
Pro Daniel, uso pessoal, rodando só no Mac dele dentro do Claude Code.
...
- Compilar depois de mudar código: `npm run build` (o Claude Code executa o resultado em `dist/`)
- O servidor está registrado no Claude Code com o nome `multimodels` (escopo user, vale pra todos os projetos); conferir com `claude mcp list`
